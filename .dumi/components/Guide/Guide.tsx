import { Icon, Link, styled } from 'styled-components';
...
const Guide: React.FC<Props> = (props) => {
  const { productName, nickName } = props;

  return (
    <StyledLayout>
      <Row>
        <Typography.Title level={3} className="title">
          {nickName ? `${nickName}，` : ''}欢迎使用{' '}
      ...
      <Row>
        <WelcomeCard.Operation
          ...
          leftActions={[
            ...
            <p key="new" style={{ marginTop: 16, fontSize: 13 }}>
              <i>
                注：新增应用默认不开启 ProLayout 布局，如需开启请参考
                <a
          ...
          rightContent={
            <WelcomeCard.QuickLinks
              links={[
                ...
                {
                  text: 'INFINITY - 数科前端工作台',
                  link: 'https://infinity.alipay.com/',
                },
              ]}
            />
          }

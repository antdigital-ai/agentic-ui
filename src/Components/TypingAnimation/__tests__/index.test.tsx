...
describe('TypingAnimation 组件', () => {
  ...
  it('应该支持自定义类名', () => {
    render(
      <TypingAnimation className="custom-class">Hello World</TypingAnimation>,
    );
  ...
  it('应该支持自定义样式', () => {
    render(
      <TypingAnimation style={{ color: 'red' }}>Hello World</TypingAnimation>,
    );
  ...
  it('应该支持暂停延迟', () => {
    render(<TypingAnimation pauseDelay={2000} words={['First', 'Second']} />);

...
| 属性            | 说明             | 类型                                                           | 默认值  | 版本 |
| --------------- | ---------------- | -------------------------------------------------------------- | ------- | ---- |
| `initialSchema` | 初始 schema 数据 | `LowCodeSchema`                                                | -       | -    |
| `initialValues` | 初始值           | `Record<string, any>`                                          | `{}`    | -    |
| `height`        | 编辑器高度       | `number \| string`                                             | `600`   | -    |
| `readonly`      | 是否只读         | `boolean`                                                      | `false` | -    |
| `onChange`      | 变更回调         | `(schema: LowCodeSchema, values: Record<string, any>) => void` | -       | -    |
| `onError`       | 错误回调         | `(error: Error) => void`                                       | -       | -    |
| `className`     | 自定义样式类名   | `string`                                                       | `''`    | -    |
| `showPreview`   | 是否显示预览     | `boolean`                                                      | `true`  | -    |
| `previewConfig` | 预览配置         | `object`                                                       | -       | -    |
